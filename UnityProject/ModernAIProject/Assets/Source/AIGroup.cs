...
public class AIGroup : IEvaluator
{
    ...
    public static QlearningExecutorRealTime executor;
    ...
    public void InitAIs(int AICount)
    {
        ...
        {
            AIController member = executor.instantiateVillager();
            member.InitializeAgent(this);
            members.Add(member);
        }
    }

    public AIController GetMemberR(int id)
    {
        return members[id];
    }
    ...
    public void InitWorld(ThreadSafe.World world)
    {
        throw new NotImplementedException();
    }

    ThreadSafe.AIController IEvaluator.GetMember(int id)
    {
        throw new NotImplementedException();
    }
}
